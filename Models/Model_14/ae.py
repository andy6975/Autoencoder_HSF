...
with tf.variable_scope('Encoder'):
    ...
    encoder_1 = tf.layers.dense(X, 400, name='encoder_1', kernel_initializer=kernel_initializer, bias_initializer=bias_initializer)
    ...
    encoder_2 = tf.layers.dense(encoder_1_ac, 200, name='encoder_2', kernel_initializer=kernel_initializer, bias_initializer=bias_initializer)
    ...
    encoder_3 = tf.layers.dense(encoder_2_ac, 100, name='encoder_3', kernel_initializer=kernel_initializer, bias_initializer=bias_initializer)
...
with tf.variable_scope('Decoder'):
    ...
    decoder_1 = tf.layers.dense(encoder_4_ac, 100, name='decoder_1', kernel_initializer=kernel_initializer, bias_initializer=bias_initializer)
    ...
    decoder_3 = tf.layers.dense(decoder_2_ac, 100, name='decoder_3', kernel_initializer=kernel_initializer, bias_initializer=bias_initializer)
