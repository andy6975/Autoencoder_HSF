...
with tf.variable_scope('Encoder'):
    ...
    encoder_1_ac = tf.nn.tanh(encoder_1, name='encoder_1_ac')
    ...
    encoder_2_ac = tf.nn.tanh(encoder_2)
    ...
    encoder_3_ac = tf.nn.tanh(encoder_3)
    ...
    encoder_4_ac = tf.nn.tanh(encoder_4)
...
with tf.variable_scope('Decoder'):
    ...
    decoder_1_ac = tf.nn.tanh(decoder_1)
    ...
    decoder_2_ac = tf.nn.tanh(decoder_2)
    ...
    decoder_3_ac = tf.nn.tanh(decoder_3)
